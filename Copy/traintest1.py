...
def _main():
    ...
    model = create_model(input_shape, anchors, num_classes) # make sure you know what you freeze
...
def create_model(input_shape, anchors, num_classes,load_pretrained=True,weights_path=''):
